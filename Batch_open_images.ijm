...
//5. Copy-paste the recorded code into this template (open in the editor from step 1.). Do not copy lines which contain the image title and are therefore specific to your example image. 
